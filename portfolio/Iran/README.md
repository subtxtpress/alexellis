...
- **Aircraft Tracking** — Live ADS-B aircraft positions from OpenSky Network across the Middle East bounding box. Filterable by aircraft type (large, medium, rotorcraft, ground vehicle), with 15-second auto-refresh, click popups showing callsign, altitude, velocity, heading, and squawk code.
...
| Aircraft | [OpenSky Network](https://opensky-network.org) ADS-B | Live, 15-second refresh |
