...
A zero-dependency, single-file OSINT tool for monitoring thermal anomalies, infrastructure impact, conflict events, maritime activity, and satellite imagery across the Middle East theater. Built for investigative journalists, OSINT analysts, and GIS researchers.

![MERIDIAN](img/meridian.png)

## What It Does

MERIDIAN fuses eight open-source intelligence layers into a single interactive map:
...
The entire application is a single HTML file (~3,900 lines). No build step, no backend, no dependencies to install. Open it in a browser and it works.
...
3. Toggle overlay layers (Industrial Sites, Conflict Events, Nighttime Lights, AIS Vessels, Satellite Imagery) for multi-source analysis
...
Data attributions: NASA FIRMS, NASA GIBS, ACLED, EOG/VIIRS Nightfire, World Bank GGFR, ESA Copernicus Sentinel-2, Maxar Open Data (CC-BY-NC 4.0), OpenStreetMap.
